...
namespace ComplyEA.Blazor.Server {
    public partial class ComplyEABlazorApplication : BlazorApplication {
        public ComplyEABlazorApplication() {
            InitializeComponent();
        }
        ...
        private void ComplyEABlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
